...
import { SaleListingsController, SaleListingsExternalController } from './sale-listings.controller';

@Module({
  imports: [TypeOrmModule.forFeature([SaleListing, Vehicle])],
  controllers: [SaleListingsController, SaleListingsExternalController],
